//#region node_modules/.nitro/vite/services/ssr/assets/db-BTUnGz53.js
...
var _0002_fight_takes_default = "create table if not exists fight_takes (\n  id         bigserial primary key,\n  user_id    text not null,\n  score      integer not null,\n  clips      integer not null,\n  grade      text not null,\n  roast      text not null default '',\n  created_at timestamptz not null default now()\n);\ncreate index if not exists fight_takes_user_id_idx on fight_takes (user_id);\n";
var _0003_take_tape_default = "alter table fight_takes add column if not exists tape_b64 text;\nalter table fight_takes add column if not exists tape_mime text;\n";
var _0004_take_replay_default = "alter table fight_takes add column if not exists replay_json text;\n";
...
async function createPgliteSql() {
	...
	const migrate = async () => {
		const migrations = /* #__PURE__ */ Object.assign({
			...
			"/migrations/0002_fight_takes.sql": _0002_fight_takes_default,
			"/migrations/0003_take_tape.sql": _0003_take_tape_default,
			"/migrations/0004_take_replay.sql": _0004_take_replay_default
		});
