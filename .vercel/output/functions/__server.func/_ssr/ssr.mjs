...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DjQbdn4p.mjs");
...
var manifest = {
	"084c683e444b98c46100f562eaa96b0bedae4b01161dc132f3ce66293638aeb0": {
		functionName: "listTakes_createServerFn_handler",
		importer: () => import("./takes-CBiHumsq.mjs")
	},
	"f990dd147cace07b7dc2ecb98d89ea46921f80e52400fa245256e7b4dfff3696": {
		functionName: "saveTake_createServerFn_handler",
		importer: () => import("./takes-CBiHumsq.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-ClpCdhnv.mjs").then((n) => n.t),
